...
if (empty($error)) {
    ...
    if ($_POST['video-type'] == 'rumble') {
        $data_insert['rumble'] = urldecode($_POST['video-id']);
        $video_ok = true;
    }
    if ($_POST['video-type'] == 'odysee') {
        $data_insert['odysee'] = urldecode($_POST['video-id']);
        $video_ok = true;
    }

    if ($_POST['video-type'] == 'bitchute') {
        $data_insert['bitchute'] = urldecode($_POST['video-id']);
        $video_ok = true;
    }
